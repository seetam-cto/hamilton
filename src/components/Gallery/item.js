...
const GalleryItem = props => {
    ...
    const ratingAverage = <Rating rating={rating_summary} />  // jrb

    return (
        <div
            data-cy="GalleryItem-root"
            className={`${classes.root} galleryRootContainer`}
            ref={itemRef}
        >
            {wishlistButton}
            <Link
            ...
            <div className={`classes.actionsContainer actionsContainer`}>
                {' '}
                {addButton}
            </div>
        </div>
